...
CGPROGRAM
// Upgrade NOTE: excluded shader from DX11; has structs without semantics (struct v2f members uv,viewDirT,I,TtoW0,TtoW1,TtoW2)
...
{	
	...
	o.I = mul( (float3x3)unity_ObjectToWorld, -objViewDir );	
