...
namespace RGSK
{
	public class Statistics : MonoBehaviour
	{
		...
		void Start()
		{
//			RaceUI.instance.randomAiFlags++;
//			aiFlag++;
//			print ("+++++++ " +aiFlag);
//			racerDetails.aiFlag = RaceUI.randomAiFlags;

//			aiFlag = RaceUI.randomAiFlags;
//			aiFlag++;
//			RaceUI.randomAiFlags++;
//			aiFlag = RaceUI.randomAiFlags;
//			RaceUI.randomAiFlags++;
//			Statistics.racerDetails.myFlag [RaceUI.randomAiFlags];

			if (!RaceManager.instance) { enabled = false; return; }

			PlyerRankAfterRace = 1;
			FindPath();
		...
		public void CalculateAITime()
		{

			currentLapTime = RaceManager.instance.AI_FormatTime (lapTimeCounter);

			totalRaceTime = RaceManager.instance.AI_FormatTime (totalTimeCounter);

		}

		public void NewLap()
		{
			//RaceUI.instance.ShowRaceInfo((finishedRace+" ::"+ knockedOut+" :: "+lap), 2.0f, Color.white);
		...
		public static int PlyerRankAfterRace=1;
		public void FinishRace()
		{
			if (finishedRace) return;

			finishedRace = true;
			Debug.Log ("-----fimished race "+gameObject);
			//Player finish
			if (gameObject.tag == "Player")
			{
				PlyerRankAfterRace=rank;
		...
		public void StopBike()
		{
			...
			{
				//				GetComponent<OpponentControl>().topSpeed = 10;
			}
