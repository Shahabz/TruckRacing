...
public class Motorbike_Control_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
		...
		m_target.MyANim = EditorGUILayout.ObjectField("Bike Animator", m_target.MyANim, typeof(Animator), true) as Animator;
		...
		m_target.IsAi = EditorGUILayout.Toggle("IsAi", m_target.IsAi);
