...
namespace RGSK
{
    public class CameraManager : MonoBehaviour
    {
		...
		public Camera StartingGridCamera2, StartingGridCamera3;
		...
		public void ActivateSecondStartingGridCamera()
		{
			startingGridCamera.GetComponent<Camera> ().enabled = false;
			StartingGridCamera2.GetComponent<Camera> ().enabled = true;
		}
		public void ActivateThirdStartingGridCamera()
		{
			StartingGridCamera2.GetComponent<Camera> ().enabled = false;
			StartingGridCamera3.GetComponent<Camera> ().enabled = true;
		}
