...
public class Race_Manager_Editor : Editor
{
    ...
    {
        //LOGO
		Texture logo = (Texture)Resources.Load("EditorUI/TimuzLogo");
        ...
        EditorGUILayout.Space();
        m_target.playerCar = EditorGUILayout.ObjectField("Player Prefab bike:", m_target.playerCar, typeof(GameObject), true) as GameObject;
        EditorGUILayout.Space();
        EditorGUILayout.Space();
...
//		m_target.PersonMaterial=EditorGUILayout.ObjectField("Player Material:", m_target.PersonMaterial, typeof(Material), true) as Material;
//		m_target.BikeMaterial=EditorGUILayout.ObjectField("Bike Material:", m_target.BikeMaterial, typeof(Material), true) as Material;
        GUILayout.EndVertical();
